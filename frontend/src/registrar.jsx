            ...
            <>
                <div className="flex justify-center items-center h-screen bg-black">
                    <div className="bg-slate-800 border-slate-400 rounded-md p-8 shadow-lg backdrop-filter backdrop-blur-sm bg-opacity-30 relative">
                        ...
                        <br />
                        <form onSubmit={handleRegistro}> {/* Capturar evento de envío del formulario */}
                            <div className="mb-4">
                                <label  className="text-white">Nombre</label>
                                <input type="text" name="Nombre" className="block w-full border-gray-300 rounded-md bg-slate-600 text-white p-2" required
                            ...
                            <div className="mb-4">
                                ...
                                <input type="text" name="Apellido" className="block w-full border-gray-300 rounded-md bg-slate-600 text-white p-2" required
                            ...
                            <div className="mb-4">
                                ...
                                <input type="email" name="Email" className="block w-full border-gray-300 rounded-md bg-slate-600 text-white p-2" required
